...
import { ArrowRight, CheckCircle2, Layers, Rocket, ShieldCheck, Users2 } from "lucide-react"
      ...
      <section className="container-shell py-12 sm:py-16 lg:py-20">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="relative perspective-[2000px]">
            ...
            <Card className="soft-card soft-card-hover absolute -bottom-6 -left-3 w-44 border-slate-100">
              <CardHeader className="p-4">
                <CardDescription className="text-xs uppercase tracking-wide text-slate-500">Sikkerhed</CardDescription>
