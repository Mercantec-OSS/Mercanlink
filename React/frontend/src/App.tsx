...
function App() {
  ...
  return (
    <Layout_alt>
      <h1 className="text-4xl font-bold absolute inset-y-190 top-25 ">Abe-mand elsker bananer</h1>
      <div className="flex flex-row items-center justify-center gap-15">

        <Card onClick={() => navigate("/valgfag")} className="border-0  w-[300px]  bg-white h-[400px] cursor-pointer">
          <img src="/src/components/images/bluey.jpg" alt="Description" className="w-full h-70 object-cover display-block rounded-t-2xl" />

          <CardTitle className="text-black text-center font-bold text-2xl">Valgfag</CardTitle>
          <CardDescription className="text-black text-center">Beskrivelse av valgfag</CardDescription>
        </Card>
